...
final class Elfi_Light_Filter {
	...
	public function i18n() {
		...
		load_plugin_textdomain( 'elfi-masonry-addon' );
	...
	public function widget_styles() {
		...
		wp_enqueue_style('elfi-masonry', ELFI_URL_LIGHT . '/assets/css/elfi-masonry-addon.min.css', array() , ELFI_VERSION_LIGHT, false);
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'elfi' ),
			'<strong>' . esc_html__( 'Elfi Masonry Filter', 'elfi' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'elfi' ) . '</strong>'
		);
