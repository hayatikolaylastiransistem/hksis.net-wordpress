       ...
       $tiembav =  $value ? $value : 'elfi';
		...
		function elfi_plugin_row_meta( $links, $file ) {    
		    if ( ELFI_BASENAME_LIGHT == $file ) {
		        $row_meta = array(
		          'docs'    => '<a href="' . esc_url( 'https://webzo.xyz/docunents/elfi-masonry-filter-addon/' ) . '" target="_blank">' . esc_html__( 'Docs', 'elfi-masonry-addon' ) . '</a>',

		          'livechat'    => '<a href="' . esc_url( 'https://webzo.xyz/live-chat/' ) . '" target="_blank">' . esc_html__( 'Live Chat', 'elfi-masonry-addon' ) . '</a>'
