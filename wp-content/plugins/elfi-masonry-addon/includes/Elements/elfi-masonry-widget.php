<?php
	...
	class Elfi_Light_Masonry_Widget extends Widget_Base {
		...
		$elfi_light_post_not_in = $settings['elfi_portfolio_not_in'];
			if($elfi_post_type == 'elfi'){
				$elfi_post_type = 'elfi';
				$elfi_taxonomy = 'el_portfolio';
				$elfi_term = $settings['elfi_portfolio'];
			}
			elseif($elfi_post_type == 'post'){
				$elfi_post_type = 'post';
	...
	if($settings['grid_clmn'] == 'two' || $settings['grid_clmn'] == 'three'|| $settings['grid_clmn'] == 'four'){
		$grid_layout = '32.33';
...
<?php } ?>
	...
	'post__not_in' => $elfi_light_post_not_in,
	...
	{ ?>
		...
		<div class="elfi-free-item elfi-free-effect__item <?php echo esc_attr($grid_effetcs); ?>">
		  ...
		  <div class="elfi-free-item__info">
		    ...
		    <h3 class="elfi-free-item__header"><?php echo elfi_light_title(); ?></h3>
