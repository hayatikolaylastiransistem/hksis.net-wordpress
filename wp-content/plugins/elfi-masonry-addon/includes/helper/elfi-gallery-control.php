<?php 
	...
	$repeater->add_control(
		...
		$repeater->add_control(
			'popup_style',
			[
				'label' => __( 'Popup Element', 'plugin-domain' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'image',
				'options' => [
					'image'  => __( 'image', 'plugin-domain' ),
					'video' => __( 'video (PRO)', 'plugin-domain' ),
					'shortcode' => __( 'shortcode (PRO)', 'plugin-domain' ),
					'rawhtml' => __( 'Raw Html (PRO)', 'plugin-domain' ),
				],
			]
		);
		$repeater->add_control(
			'popup_content',
			[
				'label' => __( 'Popup Content (PRO)', 'plugin-domain' ),
		...
		$repeater->add_control(
			'popupicon',
			[
				'label' => __( 'Popup Icon', 'text-domain' ),
		...
		$repeater->add_control(
			'enable_link',
			[
				'label' => __( 'Enable Link', 'plugin-domain' ),
		...
		$repeater->add_control(
			'enable_prevbuy',
			[
				'label' => __( 'Preview Link for Card design (PRO)', 'plugin-domain' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
		...
		$repeater->add_control(
			'preview_link',
			[
				'label' => __( 'Preview Link (PRO)', 'plugin-domain' ),
				'type' => \Elementor\Controls_Manager::URL,
				'placeholder' => __( 'https://your-link.com', 'plugin-domain' ),
				'show_external' => true,
				'default' => [
		...
		$repeater->add_control(
			'Buy_link',
			[
				'label' => __( 'Buy Link (PRO)', 'plugin-domain' ),
				'type' => \Elementor\Controls_Manager::URL,
				'placeholder' => __( 'https://your-link.com', 'plugin-domain' ),
				'show_external' => true,
				'default' => [
		...
		$this->add_control(
			'elfigallerylist',
			[
				'label' => __( 'Gallery List', 'plugin-domain' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'galley_title' => __( 'Title', 'plugin-domain' ),
						'image' => __( 'Item content. Click the edit button to change this text.', 'plugin-domain' ),
					],
					[
						'galley_title' => __( 'Title', 'plugin-domain' ),
						'image' => __( 'Item content. Click the edit button to change this text.', 'plugin-domain' ),
