<?php 
	...
	$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'raw' => __( '<a class="elfi-get-pro" href="http://sharabindu.com/plugins/elfi"  target="_blank">Go Pro</a>', 'elfi-masonry-addon' ),
				'content_classes' => 'elfi-dash-class',
				'conditions' => [
					'relation' => 'and',
					'terms' =>
					 [
		...
		$this->add_control(
					...
					[
						...
						'default' => 'three',
						'options' => [
							'two'  => esc_html__( 'Two Column (Pro!)', 'elfi-masonry-addon' ),
							'three' => esc_html__( 'Three Column', 'elfi-masonry-addon' ),
							'four' => esc_html__( 'Four Column (Pro!)', 'elfi-masonry-addon' ),
		...
		$this->add_control(
			...
			[
				'type' => \Elementor\Controls_Manager::RAW_HTML,
				'raw' => __( 'If the item per page is less than the total item number, the <b>infinite Scroll</b> works', 'elfi-masonry-addon' ),
	...
	if(class_exists('WooCommerce')){
		...
		$this->add_control(
					'add_cart_swtich',
					[
						'label' => esc_html__( 'Use icon instead of Cart text?(Pro)', 'elfi-masonry-addon' ),
						'description' => esc_html__( 'Click to use icon instead of Add to Cart text', 'elfi-masonry-addon' ),
					'type' => Controls_Manager::SWITCHER,
									'label_on' => esc_html__( 'Show', 'elfi-masonry-addon' ),
									'label_off' => esc_html__( 'Hide', 'elfi-masonry-addon' ),
									'return_value' => 'yes',
		...
		$this->add_control(
				...
				$this->add_control(
							'add_to_cart_border_radies',
							[
								'label' => esc_html__( 'Cart Border Radius(Pro)', 'elfi-masonry-addon' ),
								'description' => esc_html__( 'Add to Cart Border Radius', 'elfi-masonry-addon' ),
								'type' => Controls_Manager::SLIDER,
								'size_units' => [ 'px'],
								'range' => [
									'px' => [
...
if(class_exists('WooCommerce')){
	...
	$this->add_control(
		...
		[
			...
			'description' =>  esc_html__( 'Set Video Icon' ,'elfi-masonry-addon' ),'
			fa4compatibility' => 'icon',					
			'type' => Controls_Manager::ICONS,
			'default' => [
				'value' => 'fa fa-video',
	...
	$this->add_control(
		...
		[
			'label' => __( 'Text Transfrom', 'plugin-domain' ),
			'type' => \Elementor\Controls_Manager::SELECT,
			'options' => [
				'capitalize'  => __( 'capitalize', 'plugin-domain' ),
				'uppercase' => __( 'uppercase', 'plugin-domain' ),
				'lowercase' => __( 'lowercase', 'plugin-domain' ),
	...
	$this->add_group_control(
		...
		[
			...
			'label' => esc_html__( 'Button Typography (Pro Features !)', 'elfi-masonry-addon' ),
		]
	);
	...
	$this->add_control(
		...
		$this->add_control(
			'endof_content',
			[
				'label' => __( 'Text at the end of the item', 'plugin-domain' ),
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'rows' => 10,
				'default' => __( 'End of content', 'plugin-domain' ),
				'description' => __( 'If the field is empty the "text" will disappear', 'plugin-domain' ),
				'condition' => [
	...
	$this->add_group_control(
		...
		[
			...
			'label' => __( 'Title Typography (Pro features!)', 'elfi-masonry-addon' ),
			'selector' => '{{WRAPPER}} .portfolio_gff small',
		]
	);
	$this->add_group_control(
		Group_Control_Typography::get_type(),
		[
			...
			'label' => __( 'Category Typography (Pro features!)', 'elfi-masonry-addon' ),
			'selector' => '{{WRAPPER}} .portfolio_gff small',
		'condition' => [
		'elfi_display_types' => 'category',
	...
	$this->add_control(
		...
		[
			...
			<img class="elementor-nerd-box-icon" src="'.ELFI_URL_LIGHT.'assets/img/logo.png">
