<?php
/**
 * Plugin Name: Elfi Masonry Addon for Elementor
 * Description: Elfi is a Filter masonry which allows to create attractive portfolio filters, product filters, post-filters and Gallery masonry
 ...
 */
define('ELFI_VERSION_LIGHT', '1.2.0');
