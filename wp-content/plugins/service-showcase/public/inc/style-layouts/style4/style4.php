...
if ( is_array( $style4_service_settings ) ) {
	...
	if ( $white !== $s4_service_icon_color ) {
   ...
   <div class="row">
		...
		<div class="wlsbp <?php echo esc_attr( $s4_service_grid_layout ); ?> col-sm-6 sbp_grid">
			<div class="ServiceShowcase wlsbp-style4-service-bg-color-<?php echo esc_attr( $id ); ?>">
				...
				<i class="wlsbp-style4-service-icon wlsbp-style4-service-icon-<?php echo esc_attr( $id ); ?> <?php esc_html_e( $service['icon'] ); ?>"></i>
				<?php } ?>
				<?php if ( ! empty( $service['title'] ) ) { ?>
					<h4 class="wlsbp-style4-service-title wlsbp-style4-service-title-<?php echo esc_attr( $id ); ?>"><?php esc_html_e( $service['title'] ); ?></h4>
				<?php } ?>
				<?php if ( ! empty( $service['desc'] ) ) { ?>
					<p class="wlsbp-style4-service-desc wlsbp-style4-service-desc-<?php echo esc_attr( $id ); ?>"><?php echo wp_kses_post( $service['desc'] ); ?></p>
				<?php } ?>
				<?php if ( $s4_display_service_rmlink ) { ?>
				<a target="_blank" href="<?php echo esc_url( $service['link'] ); ?>" class="wlsbp-style4-service-readmore wlsbp-style4-service-readmore-<?php echo esc_attr( $id ); ?>"><span><?php esc_html_e( 'Read More', 'service-showcase' ); ?></span></a>
				<?php } ?>
			</div>
		</div>
				<?php
