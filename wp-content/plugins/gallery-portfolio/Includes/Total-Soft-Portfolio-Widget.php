		...
		<?php } else if ( $TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType == 'Elastic Grid' ) { ?>
         <style type="text/css">
             ...
             ul.portfolio-filter<?php echo $Total_Soft_Portfolio; ?> a:hover {
                 ...
                 background: <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_16;?>;
             ...
             .wagwep-container<?php echo $Total_Soft_Portfolio; ?> ul.portfolio-filter<?php echo $Total_Soft_Portfolio; ?> a {
                 ...
                 color: <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_13;?> !important;
             ...
             .ogtot-grid<?php echo $Total_Soft_Portfolio; ?> li > a, .ogtot-grid<?php echo $Total_Soft_Portfolio; ?> li > a img {
                 width: <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_21;?>px !important;
                 height: <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_22;?>px !important;
             ...
             .ogtot-expander<?php echo $Total_Soft_Portfolio; ?> {
                 ...
                 /*overflow: overlay;*/
                 /*padding-bottom: 5px;*/
             <?php if ($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_08>600) {?> max-height: <?php echo(($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_08));?>px;
             <?php } else{?> max-height: <?php echo(($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_08));?>px !important;
             <?php } ?> /*max-height:
             ...
             .elastislidetot<?php echo $Total_Soft_Portfolio; ?>-list li a img, .elastislidetot<?php echo $Total_Soft_Portfolio; ?>-list li a, .elastislidetot<?php echo $Total_Soft_Portfolio; ?>-list li, .elastislidetot<?php echo $Total_Soft_Portfolio; ?>-list {
                 height: <?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_12;?>px !important;
				 width: <?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_12;?>px !important;
                 box-shadow: none;
			...
			console.log("asd");
             ...
             g.elastislidetot<?php echo $Total_Soft_Portfolio; ?>.prototype = {
               _init: function (l) {
                 ...
                 this._setItemsSize();
                 this.options.orientation === "horizontal" ? this.$el.css("max-height", this.imgSize.height) : this.$el.css("height", this.imgSize.height * this.options.minItems);
                 this._addControls()
           ...
           jQuery(function () {
             ...
             jQuery.fn.elastic_grid<?php echo $Total_Soft_Portfolio; ?>= function (G) {
               ...
               function z() {
                 ...
                 jQuery(".ogtot-expander<?php echo $Total_Soft_Portfolio; ?>").css('overflow', '','height','auto');
                 y = -1;
                 var i = jQuery.data(this, "preview");
                 if (typeof i == "undefined") {
                 } else {
               ...
               e.prototype = {
                 create: function () {
                   ...
                   height_link =jQuery(this.$previewEl).find('a').attr('href').height,
				//    height = 30,
		...
		<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType == 'Filterable Grid'){ ?>
				<style type="text/css">
					<?php if($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_02!='0'){ ?>
						...
						{
							padding: <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_02;?>px !important;
							background-color: <?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_03;?>;
						}
						.slider<?php echo $Total_Soft_Portfolio; ?> i{
					...
					.carSliderPortRel { position:relative; margin-left:auto; margin-right:auto; width: 100% !important; }
					.carImgs
					{
					...
					.slider__item { position:relative; width: 100%; overflow:hidden;outline: none !important;
 }
					.slider__item a{
						font-family: 'FontAwesome' !important;
						line-height: 1 !important;
					...
					.action:focus { outline: none !important; border:none !important; }
					.no-touch .action--button:hover { outline: none !important; background:none; border:none !important;}
			...
			<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType == 'Gallery Portfolio/Content Popup'){ ?>
				...
				$.TSprettyPhoto.initialize=function(){settings=tspp_settings;if(navigator.userAgent.match(/MSIE ([0-9]+)\./)&&parseInt($.browser.version)==6)settings.theme="light_square";_buildOverlay(this);if(settings.allow_resize)
				...
				<style type="text/css">
					...
					.totalsoft-image-block img { margin: 0 !important; background:#FFFFFF; width:100% !important; height: 100% !important; max-width:none !important; }
					.TotPortImgHov1
					{
						position:absolute;
						top:0px;
				...
				<div class="totalsoft-TS_Portfolio_GAA_ totalsoft-TS_Portfolio_GAA_<?php echo $Total_Soft_Portfolio; ?>" >
					<div class="totalsoft-portfolio-content" >
						...
						<ul class="totalsoft-portfolio-area<?php echo $Total_Soft_Portfolio; ?>" style='padding:0px;margin:0px;text-align:center;display: none;'>
							...
							<?php }} ?>
							<style>
							.totalsoft-portfolio-categ<?php echo $Total_Soft_Portfolio; ?> a{
								font-family: 'FontAwesome' !important;
							 }					
							</style>
